...
internal static class V1DataImportServiceExtensions
{
    ...
    {
        return Tuple.Create(owner, fileName, mimeType, fileStream);
    }
    ...
    internal static Tuple<string, string> CreateShoutoutCall(string channel, string message)
    {
    ...
    {
        service.SetShoutoutMessage(preparedCall.Item1, preparedCall.Item2);
    }
}
