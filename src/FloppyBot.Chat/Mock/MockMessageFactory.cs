...
{
    public static ChatMessageIdentifier NewChatMessageIdentifier(string channelName = "Channel")
    {
    ...
    public static ChannelIdentifier NewChatUserIdentifier(string username = "UserName")
    {
        return new ChannelIdentifier(MockChatInterface.IF_NAME, username);
    }
    ...
    {
        return new ChatUser(NewChatUserIdentifier(userId), userName ?? userId, privilegeLevel);
    }
