...
public static class Dependencies
{
    ...
    {
        return services.AddSingleton<KillSwitchReceiver>();
    }

    public static IServiceCollection AddKillSwitchTrigger(this IServiceCollection services)
    {
        return services.AddScoped<IKillSwitchTrigger, KillSwitchTriggerSender>();
    }

    public static THost ArmKillSwitch<THost>(this THost host)
        where THost : IHost
    {
