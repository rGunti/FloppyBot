...
public static class ImmutableListExtensions
{
    ...
    public static IImmutableList<T> ToImmutableListWithValueSemantics<T>(
    ...
    public static IImmutableSet<T> ToImmutableHashSetWithValueSemantics<T>(
        this IEnumerable<T> enumerable
    ) => enumerable.ToImmutableHashSet().WithValueSemantics();

    public static IImmutableSet<T> ToImmutableSortedSetWithValueSemantics<T>(
        this IEnumerable<T> enumerable
